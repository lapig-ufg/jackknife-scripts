...
c ... Function declarations
      real     fracis, line, pevap 
      external fracis, line, pevap 
...
c ..... Add initialization for defacm(*), cak - 05/28/02
        agdefacm(mon) = -1.
        bgdefacm(mon) = -1.
10    continue
...
c!!        sitpot = line(prcann, 20.0, 1500.0, 90.0, 3250.0)
c!!      endif
c!!      sitpot = sitpot * sitpot_m
