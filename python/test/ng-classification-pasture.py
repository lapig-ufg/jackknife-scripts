...
config = {
    "grid": {
      "tiles": ['215067','217072','218063','218066','218069','219064','219065','219067','219066','219068','219070','219071','219072','219073','219076','220066','220073','220072','221065','221068','224077','225072','226067','226071','227068'],
      #"tiles": ['227067', '217065'],
      ...
      , "series": [
        {
          ...
          "composites": [
               { "id": "1", "dates": [ { "start": "2014-02-01", "end": "2014-03-31" }, { "start": "2015-02-01", "end": "2015-03-31" } ] }
            ,  { "id": "2", "dates": [ { "start": "2013-04-01", "end": "2013-05-31" }, { "start": "2014-04-01", "end": "2014-05-31" }, { "start": "2015-05-01", "end": "2015-05-31" } ] }
            ,  { "id": "3", "dates": [ { "start": "2013-06-01", "end": "2013-07-31" }, { "start": "2014-06-01", "end": "2014-07-31" }, { "start": "2015-06-01", "end": "2015-07-31" } ] }
            ,  { "id": "4", "dates": [ { "start": "2013-08-01", "end": "2013-09-30" }, { "start": "2014-08-01", "end": "2014-09-30" }, { "start": "2015-08-01", "end": "2015-09-30" } ] }
            ,  { "id": "5", "dates": [ { "start": "2013-10-01", "end": "2013-11-30" }, { "start": "2014-10-01", "end": "2014-11-30" }, { "start": "2015-10-01", "end": "2015-11-08" } ] }
            ,  { "id": "6", "dates": [ { "start": "2013-12-01", "end": "2014-01-30" }, { "start": "2014-12-01", "end": "2015-01-30" } ] }
          ]
        }
      ]
  }
...
def getTrainningDataset(image, gridCell, seed):
  ...
  for classValue in classValues:
    ...
    if strategy == 'percentage':
      ...
      if classPct > 0.01 and classPct < 0.30:
        classPct = 0.30
      elif classPct > 0.70:
        classPct = 0.70
...
def getClassifiers(mvc, gridCell):
  ...
  for i in xrange(0,nExecutions):
    ...
    if trainningDataset is not None:
      classifier = ee.Classifier.randomForest(nTrees, variablesPerSplit, 1);
